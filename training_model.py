...
'''
Part 1:
- Created Dataset to be used in RNN
- As asked commented the complete section, however detailed steps are mentioned in Report
...
# '''
# Now, as per requirement, Create the dataset using the latest 3 days as features and next day opening price as target
...
if __name__ == "__main__":
    ...
    '''
    Below are Extra Models (commented out with their results) which I've tried and helped me in obtaining optimal model.
    Explanation has been provided in Report.
    ...
    '''
    EXTRA PART: Cheking Training Mean Square Error for Reporting Purpose
    ...
    ## Save the model
    RNN_Model.save('models/20842555_RNN_model.h5')
